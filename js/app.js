...
Car.prototype.update = function(dt) {
    ...
    this.x=-90;
        if(character.score>=2) {
            this.speed = randomIntFromInterval(200,500);
            goToLevel(2);
        }
        else if(character.score>=8) {
...
Car.prototype.render = function() {
    ctx.drawImage(Resources.get(this.sprite), this.x, this.y, this.width, this.hight);
};
...
var a = new Car(-1000, 70);
var b = new Car(-1000, 240);
var c = new Car(-1000, 325);
var d = new Car(-20, 500);
